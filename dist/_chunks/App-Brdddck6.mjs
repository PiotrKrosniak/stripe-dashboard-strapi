...
import { Box, Loader, Main, Typography, Table, Thead, Tr, Th, Tbody, Td } from "@strapi/design-system";
    ...
    /* @__PURE__ */ jsxs(
      Box,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs(Table, { colCount: 4, rowCount: payments.length, children: [
...
//# sourceMappingURL=App-Brdddck6.mjs.map
